    ...
    <>
      ...
      <div className="relative min-h-screen bg-cream2 text-slate-800 font-sans flex flex-col">
        ...
        <div className="flex-1 max-w-7xl w-full mx-auto px-4 md:px-8 py-8 flex flex-col lg:flex-row gap-8">
              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-xl text-xs uppercase tracking-wider font-bold transition-all border ${tab === t.id
          ...
          <aside className="hidden lg:flex lg:w-64 shrink-0 flex-col gap-1.5 relative z-10 lg:sticky lg:top-[90px] self-start transform-gpu">
            {[
              { id: 'dashboard', label: 'Sales Overview', icon: TrendingUp },
              { id: 'products', label: 'Products & Stock', icon: Package },
              { id: 'orders', label: 'Sales & Orders', icon: ShoppingBag },
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl text-xs uppercase tracking-wider font-bold transition-all duration-300 cursor-pointer border ${tab === t.id
